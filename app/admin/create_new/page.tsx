...
export default function App() {
    ...
    async function  sendToBackend(){
      ...
      const response = await fetch("http://localhost:3000/api/create_blog", {
        method : "POST",
        headers: {
    ...
    <>
      ...
      init={{
        ...
        templates: [
          ...
          { title: 'Starting my story', description: "A cure for writer's block", content: 'Once upon a time...' },
          {
      ...
      <button onClick={() => { sendToBackend() }}>Print Content</button>
    </>
  );
}